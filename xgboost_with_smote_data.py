...
# Using higher SMOTE ratios for Ella to avoid the FitFailedWarning!
param_grid = {
...
plt.title('Real-World Test Data - Confusion Matrix (XGBoost)')
...
sns.heatmap(cm_smote, annot=True, fmt='d', cmap='Greens', 
            xticklabels=["Predicted Safe", "Predicted Hotspot"], 
            yticklabels=["Actually Safe", "Actually Hotspot"])
plt.title('Training Data (with SMOTE) - Confusion Matrix (XGBoost)')
